"""
Django settings for restless_dawn_3 project.
...
ROOT_URLCONF = 'restless_dawn_3.urls'
...
WSGI_APPLICATION = 'restless_dawn_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Restless Dawn Support <support@restless-dawn-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_dawn_3 API",
    "DESCRIPTION": "API documentation for restless_dawn_3 App",
    "VERSION": "v1",
}
